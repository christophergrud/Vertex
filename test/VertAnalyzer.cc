// -*- C++ -*-
//
// Package:    VertAnalyzer
// Class:      VertAnalyzer
// 
/**\class VertAnalyzer VertAnalyzer.cc RecoVertex/V0Producer/test/VertAnalyzer.cc
...
// $Id: VertAnalyzer.cc,v 1.16 2011/11/12 01:39:27 drell Exp $
//
//
...
class VertAnalyzer : public edm::EDAnalyzer {
   public:
      explicit VertAnalyzer(const edm::ParameterSet&);
      ~VertAnalyzer();
...
//
VertAnalyzer::VertAnalyzer(const edm::ParameterSet& iConfig):
...
void VertAnalyzer::analyze(const edm::Event& iEvent, 
...
DEFINE_FWK_MODULE(VertAnalyzer);
