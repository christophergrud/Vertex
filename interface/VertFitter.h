...
// $Id: VertFitter.h,v 1.56 2011/12/23 08:13:39 innocent Exp $
//
...
class VertFitter {
 public:
  VertFitter(const edm::ParameterSet& theParams,
  ...
  const reco::VertexCompositeCandidateCollection& getMyVertices() const; // *****************************************************************
 ...
 private:
  ...
  reco::VertexCompositeCandidateCollection theMyVertices; // ********************************************************************************
  ...
  // Helper method that does the actual fitting using the KalmanV0Fitter
